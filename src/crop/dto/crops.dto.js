...
const CropDto = Joi.object({
  ...
  Yield: Joi.number().precision(precsionThree).allow(null),
  ...
  MilkYield: Joi.number().allow(null).precision(precsionThree).default(0).allow(null),
  ConcentrateUse: Joi.number().allow(null).precision(precsionThree).default(0).allow(null),
  StockingRate: Joi.number().allow(null).precision(precsionThree).default(0).allow(null),
