...
class UpdateRecommendation {
  ...
  async handleFarmValidation(farmId, transactionalManager) {
    const errors = [];
  ...
  async handleFieldValidation(fieldId, transactionalManager) {
    const errors = [];
  ...
  async getManagementPeriod(id, transactionalManager) {
