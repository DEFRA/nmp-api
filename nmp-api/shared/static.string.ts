export class StaticStrings {
  ...
  public static INFO_RESOURCE_CREATED: string = 'Resource created successfully.';
  public static INFO_RESOURCE_UPDATED: string = 'Resource updated successfully.';
  public static INFO_RESOURCE_DELETED: string = 'Resource deleted successfully.';
  ...
  public static ERR_OPERATION_NOT_PERMITTED: string = 'Operation not permitted.';
  public static ERR_INVALID_REQUEST: string = 'Invalid request.';
  public static ERR_EMAIL_ALREADY_REGISTERED: string = 'Email is already registered.';
  public static ERR_USERNAME_ALREADY_TAKEN: string = 'Username is already taken.';
  ...
  public static INFO_PASSWORD_RESET_LINK_SENT: string = 'Password reset link has been sent to your email.';
